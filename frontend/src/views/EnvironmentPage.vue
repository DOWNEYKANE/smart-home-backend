...
const controls = computed(() => [
  {
    ...
    onValue: 'on', offValue: 'off', onLabel: '运行中（点击关闭）', offLabel: '已关闭（点击开启）'
  },
  {
    key: 'tempThreshold', label: '温度上限阈值', type: 'threshold',
    value: 30, unit: '°C'
  },
  {
    key: 'humidityThreshold', label: '湿度上限阈值', type: 'threshold',
    value: 70, unit: '%'
  },
  {
    key: 'smokeThreshold', label: '烟雾浓度阈值', type: 'threshold',
    value: 200, unit: 'ppm'
  },
])
</script>
